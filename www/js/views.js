...
(function() {
  ...
  directory.views.CalendarPage = CalendarPage = (function(_super) {
    ...
    CalendarPage.prototype.initialize = function() {
      ...
      return this.calendarListTemplate = _.template(directory.utils.templateLoader.get('calendar-list'));
    };
    ...
    CalendarPage.prototype.create = function() {
      console.log("create");
  ...
  directory.views.ContactListItemView = ContactListItemView = (function(_super) {
    ...
    ContactListItemView.name = 'ContactListItemView';
  ...
  directory.views.FeedsPage = FeedsPage = (function(_super) {
    ...
    FeedsPage.prototype.initialize = function() {
      ...
      return this.tweetTemplate = _.template(directory.utils.templateLoader.get('tweet-template'));
    };
