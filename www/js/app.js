...
(function() {
  ...
  $(document).ready(function() {
    ...
    return employeeDAO.initialize(function() {
      return directory.utils.templateLoader.load(['search-page', 'group-page', 'contact-page', 'contact-list-item', 'sync-page', 'feed-page', 'tweet-template', 'home-page', 'calendar-list', 'calendar-page'], function() {
